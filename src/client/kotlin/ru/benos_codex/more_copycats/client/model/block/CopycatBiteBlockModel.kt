...
class CopycatBiteBlockModel(state: BlockState, unbaked: BlockStateModel.UnbakedRoot): CopycatModel(state, unbaked) {
    ...
    override fun addPartsWithInfo(
        ...
        val blockEntity = p0.getBlockEntity(p1) as? CopycatBiteBlockEntity
